...
package org.wso2.carbon.andes.extensions.authentication.mqtt.exception;

public class MqttConfigurationException extends Exception{

    public MqttConfigurationException(String message, Throwable cause, boolean enableSuppression,
